...
class CommentServiceTest {
    ...
    public void deleteCommentTest() {
        ...
        User user = new User("username","123123", UserRoleEnum.ADMIN);
        ...
        ResponseEntity<MsgResponseDto> msgresponse = new ResponseEntity<>(new MsgResponseDto("댓글 삭제 성공", HttpStatus.OK.value()), HttpStatus.OK);

        // then
        assertEquals(HttpStatus.OK, msgresponse.getStatusCode());
        assertEquals("댓글 삭제 성공", (msgresponse.getBody().getMsg()));
